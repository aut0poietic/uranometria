// One formatter, so a star's label and its designation can never drift.
...
/**
 * HYG bayer token + constellation abbr → "α² Cap". Accepts "Alp", "Alp-2", "Alp2".
 * Returns null on an unmapped token; the caller decides how to report it.
 */
