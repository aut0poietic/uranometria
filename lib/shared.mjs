...
// the arcmin-scale centroids of the nebula catalogs that need this (Sharpless
// VII/20, Lynds VII/9); validated against SIMBAD J2000 positions in
// parsers/sharpless.mjs (median offset ~1.2′ = centroid noise).
const FK4_TO_FK5 = [
